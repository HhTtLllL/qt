...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ClientWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 61, 22)
    ...
    "ClientWidget\0on_buttonConnect_clicked\0"
    "\0on_buttonSend_clicked\0on_buttonClose_clicked"
};
...
const QMetaObject ClientWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ClientWidget.data,
      qt_meta_data_ClientWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ClientWidget.stringdata))
