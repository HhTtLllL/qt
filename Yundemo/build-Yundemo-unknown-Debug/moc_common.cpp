...
#include "../Yundemo/common/common.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Common_t, stringdata) + ofs \
...
const QMetaObject Common::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Common.data,
      qt_meta_data_Common,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Common.stringdata))
